...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Assets', path: '/assets', entity: 'asset', service: AccessServiceEnum.PROJECT, icon: FiFile },
    { name: 'Metrics', path: '/metrics', entity: 'metric', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
