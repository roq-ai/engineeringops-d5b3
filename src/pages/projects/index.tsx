...
export function ProjectListPage(props: ProjectListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProjects({
        relations: ['organization', 'user', 'asset.count', 'metric.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('asset', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('metric', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'metric',
          header: 'Metric',
          accessorKey: 'metric',
          cell: ({ row: { original: record } }: any) => record?._count?.metric,
        }
      : null,
